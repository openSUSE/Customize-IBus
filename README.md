...
- [x] V40: 修复输入源指示器定时关闭缺陷，增加更多配置。增加 IBus 输入框弹出动画配置功能，当 GNOME PR [#1836](https://gitlab.gnome.org/GNOME/gnome-shell/-/merge_requests/1836)被合并后可用。
...
- [x] V40: Fix input source indicator BUGS, add more configs. Add IBus Input Popup Box animation customization feature, works When GNOME PR [#1836](https://gitlab.gnome.org/GNOME/gnome-shell/-/merge_requests/1836) got merged.
