...
const IBusThemeManager = GObject.registerClass({
    ...
    _replaceStyle() {
        ...
        this._colorScheme = ['red', 'green', 'orange', 'blue', 'purple', 'turquoise', 'grey'];
    ...
    _restoreStyle() {
        ...
        delete this._popup;
        delete this._colorScheme;
    }

    set color(color) {
        this._color = this._colorScheme[color];
        if (this._prvColor)
    ...
    _bindSettings() {
        gsettings.bind(Fields.CUSTOMTHEMECOLOR, this, 'color', Gio.SettingsBindFlags.GET);
    }
...
const Extensions = GObject.registerClass({
    ...
    _bindSettings() {
        ...
        gsettings.bind(Fields.ENABLECUSTOMTHEME, this, 'theme', Gio.SettingsBindFlags.GET);
