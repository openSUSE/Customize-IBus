    ...
    _aboutPage() {
      ...
      frame.grid.attach(
        new Gtk.Label({
          use_markup: true,
          label: _(
            '<span size="small">Copyright © 2021 <a href="https://github.com/openSUSE">Hollow Man</a> &lt;<a href="mailto:hollowman@hollowman.ml">hollowman@hollowman.ml</a>&gt;</span>'
          ),
        }),
        0,
        frame.grid._row++,
    ...
    _themeHelpPage(frame) {
      ...
      expanderFrame.grid.attach(
        new Gtk.Label({
          ...
          wrap: true,
          label: _(
            'Support importing stylesheet generated by <a href="https://github.com/openSUSE/IBus-Theme">IBus Theme Tool</a> or provided by <a href="https://github.com/openSUSE/IBus-Theme-Hub">IBus Theme Hub</a>.'
          ),
        }),
        0,
        expanderFrame.grid._row++,
