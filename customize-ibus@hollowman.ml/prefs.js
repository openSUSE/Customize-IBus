...
const CustomizeIBus = GObject.registerClass(
    class CustomizeIBus extends Gtk.ScrolledWindow {
        ...
        _bulidWidget() {
            ...
            this._field_use_custom_font = this._checkMaker(
                _('Use custom font')
            );
            ...
            this._field_enable_ASCII = this._checkMaker(
                _('Auto switch ASCII mode')
            );
            this._field_enable_orien = this._checkMaker(
                _('Candidates orientation')
            );
            ...
            this._open_logo_button = this._iconLinkButtonMaker(
                '',
                'document-open'
            );
            ...
            this._open_css_button = this._iconLinkButtonMaker(
                '',
                'document-open'
            );
        ...
        _bulidUI() {
            ...
            this._ibus_basic._add(
                this._switchLabelMaker(
                    _('Enable drag to reposition candidate box')
                ),
            ...
            this._ibus_indicator._add(
                this._switchLabelMaker(
                    _('Indicate only when switching input source')
                ),
                this._field_indicator_only_toggle
            );
            this._ibus_indicator._add(
                this._switchLabelMaker(
                    _('Indicate only when using ASCII mode')
                ),
                this._field_indicator_only_in_ASCII
            );
            this._ibus_indicator._add(
                this._switchLabelMaker(
                    _("Don't indicate when using single mode IME")
                ),
                this._field_indicator_not_single_IME
            );
            this._ibus_indicator._add(
                this._switchLabelMaker(
                    _('Enable right click to close indicator')
                ),
                this._field_indicator_right_close
            );
            this._ibus_indicator._add(
                this._switchLabelMaker(
                    _('Enable scroll to switch input source')
                ),
            ...
            this._ibus_settings._add(
                new Gtk.Label({
                    ...
                    label:
                        '<b>' +
                        _('Other official IBus customization settings') +
                        '</b>',
                })
            );
            this._ibus_settings._add(
        ...
        _syncStatus() {
            ...
            this._field_use_candidate_scroll.connect(
                'notify::active',
                widget => {
            ...
            this._field_use_candidate_still.connect(
                'notify::active',
                widget => {
            ...
            this._field_use_tray.connect('notify::active', widget => {
                ...
                this.ibus_settings.set_boolean(
            ...
            this._field_indicator_use_opacity.connect(
                'notify::active',
                widget => {
            ...
            this._field_use_candidate_opacity.connect(
                'notify::active',
                widget => {
            ...
            this._field_enable_custom_theme.connect(
                'notify::active',
                widget => {
                ...
                this._showFileChooser(
                    ...
                    filename => {
                        if (
                            ...
                            stdin = new Gio.UnixOutputStream({
                                fd: stdin,
                                close_fd: true,
                            });
                            GLib.close(stdout);
            ...
            this._field_remember_input.set_sensitive(
                this._field_enable_ASCII.active
            );
            this._field_unkown_state.set_sensitive(
                this._field_enable_ASCII.active
            );
            this._field_orientation.set_sensitive(
                this._field_enable_orien.active
            );
            this._field_candidate_animation.set_sensitive(
            ...
            this._field_extension_entry.set_sensitive(
                this._field_use_tray.active
            );
            this._field_ibus_preference.set_sensitive(
                this._field_use_tray.active
            );
            ...
            this._field_custom_font.set_sensitive(
                this._field_use_custom_font.active
            );
            ...
            this._reset_logo_button.set_sensitive(
                this._field_use_custom_bg.active
            );
            this._open_logo_button.set_sensitive(
                this._field_use_custom_bg.active
            );
            this._logoDarkPicker.set_sensitive(
                this._field_use_custom_bg_dark.active
            );
        ...
        _createAdjustment(key, step_increment) {
            ...
            if (type !== 'range')
                throw new Error(
                    'Invalid key type "%s" for adjustment'.format(type)
                );
        ...
        _showFileChooser(
            ...
            let dialog = new Gtk.FileChooserDialog(
                mergeObjects(
                    {title: title, transient_for: transient_for},
                    params
                )
            );
            if (setDefaultName)
        ...
        _resetExtension() {
            ...
            dialog.connect('response', (d, id) => {
                ...
                for (let field in Fields)
                    if (field !== 'IBUSRESTTIME')
                        this.gsettings.reset(Fields[field]);
                d.destroy();
            });
            dialog.show();
        }
