...
export default [
    ...
    {
        files: ['**/*.js', '**/*.mjs'], // Adjust according to your file types
        ...
        rules: {
            ...rules.rules, // Spread the rules from eslint-config-prettier
            'prettier/prettier': 'error', // Enable the prettier plugin
